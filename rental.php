                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3 row">
                                                    <h5  class="col-sm-1 mt-1">Nama PS</h5>
                                                        <div class="col-sm-11">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3 row">
                                                    <h5  class="col-sm-1 mt-1">Jenis Game</h5>
                                                        <div class="col-sm-11">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <h5  class="col-sm-1 mt-1">Estimasi</h5>
                                                        ...
                                                        <select name="estimasi" id="" class="form-control">
                                                            ...
                                                            <option value="5 hours">5 Jam</option>
                                        ...
                                        if (isset($_POST['order'])) {
                                            ...
                                            $hours = 'hours';
                                            date_add($waktu, date_interval_create_from_date_string($sewaestimasi));
                                            $jumlahwaktu =  date_format($waktu, 'H:i:s');
