                               ...
                               <?php if ($pecahuser['level'] == '1'){?>
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-12 text-center">
                                            <a href="lap.php" type="button" class="btn btn-secondary">Kembali</a>
                                            <a href="konfir_order_cetak.php?id=<?php echo $_GET['id'] ?>" type="button" class="btn btn-primary">Cetak</a>
                                        </div>
                                    </div>
                                </div>
                               <?php }else{?>
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="cpl-lg-2"></div>
                                        <div class="col-lg-12 text-center">
                                            <a href="history.php" type="button" class="btn btn-secondary">Kembali</a>
                                            <a href="history.php" type="button" class="btn btn-primary">Simpan</a>
                                            <a href="konfir_order_cetak.php?id=<?php echo $_GET['id'] ?>" type="button" class="btn btn-primary">Cetak</a>
                                        </div>
                                    </div>
                                </div>
