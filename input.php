        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ruang Input Data Data</h1>
                        </div><!-- /.col -->
                                    ...
                                    <form method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Nama Game</h5>
                                                    <input type="text" class="form-control" placeholder="Input disini ..." name="nama_game">
                                                </div>
                                                <div class="form-group">
                                                    <h5>Pilih PS</h5>
                                                    <div class="form-group">
                                                        <select name="id_ps" id="" class="form-control">
                                                            <option value="">- Pilih -</option>
                                                            <?php $ambil_barang = $koneksi->query("SELECT * FROM tb_barang"); ?>
                                                ...
                                                <div class="form-group">
                                                    <h5>Deskripsi</h5>
                                                    <textarea class="form-control" name="deskripsi_ps" id="" cols="30" rows="8"></textarea>
                                                </div>
                                                <div class="text-right">
                                                    <a href="index.php" class="btn btn-secondary">Batalkan</a>
                                                    <button type="submit" name="simpan_game" class="btn btn-primary">Simpan</button>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
